...
//  `.wannaShortcutRecorderStateChanged` so `CompanionManager` can suspend the
...
extension Notification.Name {
    static let wannaShortcutRecorderStateChanged = Notification.Name("wannaShortcutRecorderStateChanged")
}
...
struct ShortcutRecorderButton: View {
    ...
    private func startRecording() {
        ...
        NotificationCenter.default.post(name: .wannaShortcutRecorderStateChanged, object: true)
    ...
    private func stopRecording() {
        ...
        isRecording = false
        NotificationCenter.default.post(name: .wannaShortcutRecorderStateChanged, object: false)
    }
