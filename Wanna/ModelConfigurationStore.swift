...
nonisolated extension Notification.Name {
    ...
    static let wannaModelConfigurationChanged = Notification.Name("wannaModelConfigurationChanged")
}
...
nonisolated enum ModelConfigurationStore {
    ...
    static func save(_ configuration: ModelConfiguration) throws {
        ...
        NotificationCenter.default.post(name: .wannaModelConfigurationChanged, object: nil)
    }
