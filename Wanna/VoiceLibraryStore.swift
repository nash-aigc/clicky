...
nonisolated extension Notification.Name {
    ...
    static let wannaVoiceLibraryChanged = Notification.Name("wannaVoiceLibraryChanged")
}
...
nonisolated enum VoiceLibraryStore {
    ...
    private static func save(_ library: VoiceLibrary) throws {
        ...
        NotificationCenter.default.post(name: .wannaVoiceLibraryChanged, object: nil)
    }
}
