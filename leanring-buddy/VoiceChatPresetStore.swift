...
nonisolated extension Notification.Name {
    static let clickyVoiceChatPresetsDidChange =
        Notification.Name("clickyVoiceChatPresetsDidChange")
}
...
nonisolated enum VoiceChatPresetStore {
    ...
    private static func mutate(_ body: (inout [String: VoiceChatPresetOverride]) -> Void) {
        ...
        writeToDisk(store)
        NotificationCenter.default.post(name: .clickyVoiceChatPresetsDidChange, object: nil)
    }
