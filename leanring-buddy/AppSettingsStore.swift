...
nonisolated extension Notification.Name {
    ...
    static let clickyAppSettingsChanged = Notification.Name("clickyAppSettingsChanged")
}
...
nonisolated enum AppSettingsStore {
    ...
    static func save(_ settings: AppSettings) throws {
        ...
        NotificationCenter.default.post(name: .clickyAppSettingsChanged, object: nil)
    }
