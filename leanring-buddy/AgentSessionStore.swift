...
//  apart, and a change notification (`clickyAgentSessionsDidChange`) so live
...
nonisolated extension Notification.Name {
    static let clickyAgentSessionsDidChange = Notification.Name("clickyAgentSessionsDidChange")
}
...
nonisolated enum AgentSessionStore {
    ...
    private static func mutate(_ mutation: (inout StoredAgentSessions) -> Void) {        sessionsLock.lock()
        ...
        NotificationCenter.default.post(name: .clickyAgentSessionsDidChange, object: nil)
    }
