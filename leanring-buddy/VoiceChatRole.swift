...
nonisolated extension Notification.Name {
    static let clickyVoiceChatRolesDidChange = Notification.Name("clickyVoiceChatRolesDidChange")
}
...
nonisolated enum VoiceChatRoleStore {
    ...
    private static func mutate(_ change: (inout StoredVoiceChatRoles) -> Void) {
        ...
        writeToDisk(stored)
        NotificationCenter.default.post(name: .clickyVoiceChatRolesDidChange, object: nil)
    }
