...
来源文件都在 `leanring-buddy/` 下，行号是备份那一刻的。
...
- 出处：`leanring-buddy/CompanionManager.swift:1748`
- 长度：22649 字符
...
- 出处：`leanring-buddy/CompanionManager.swift:3974`
- 长度：1892 字符
...
- 出处：`leanring-buddy/RecordingPolishStyle.swift:116`
- 长度：4078 字符
...
- 出处：`leanring-buddy/VoiceChatRole.swift:117`
- 长度：72 字符
